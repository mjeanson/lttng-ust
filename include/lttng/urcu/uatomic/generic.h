...
/* lttng_ust_uatomic_sub_return, lttng_ust_uatomic_add, lttng_ust_uatomic_sub, lttng_ust_uatomic_inc, lttng_ust_uatomic_dec */
...
#define lttng_ust_uatomic_sub_return(addr, v)	\
	lttng_ust_uatomic_add_return((addr), -(lttng_ust_cast_long_keep_sign(v)))
#define lttng_ust_uatomic_sub(addr, v)		\
...
#ifndef lttng_ust_uatomic_inc
#define lttng_ust_uatomic_inc(addr)		lttng_ust_uatomic_add((addr), 1)
...
#ifndef lttng_ust_uatomic_dec
#define lttng_ust_uatomic_dec(addr)		lttng_ust_uatomic_add((addr), -1)
