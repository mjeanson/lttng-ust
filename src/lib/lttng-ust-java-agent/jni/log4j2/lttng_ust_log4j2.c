...
#define _LGPL_SOURCE
#include "org_lttng_ust_agent_log4j2_LttngLog4jApi.h"
...
#include "lttng_ust_log4j2.h"
#include "../common/lttng_ust_context.h"

/*
 * Tracepoint used by Java applications using the log4j 2.x handler.
 */
JNIEXPORT void JNICALL Java_org_lttng_ust_agent_log4j2_LttngLog4jApi_tracepointWithContext(JNIEnv *env,
						...
						jbyteArray context_info_strings)
{
	...
	// FIXME: keep the provider name 'lttng_log4j', requires no modifications in tools
